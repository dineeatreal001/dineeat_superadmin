...
const AddStorePage = () => {
  ...
  const [otherDetails, setOtherDetails] = useState({
    ...
    subscriptionType: '', bankName: '', accountNumber: '', ifscCode: '', upiId: ''
  });
  ...
  const handleCreateStore = async () => {
    try {
      ...
      const response = await axios.post(`${process.env.NEXT_PUBLIC_URL}/store/create`, payload);
  ...
  return (
    <div className="min-h-screen bg-[#f1f2f8]">
      ...
      <div className={`transition-all duration-300 pt-20 ${!isMobile && (isSidebarOpen ? 'ml-64' : 'ml-20')}`}>
        <style>{`
          ...
          <div className="flex-1 min-w-0">
            <div className="relative pl-4 md:pl-20">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="relative p-4 md:p-5 bg-white rounded-xl border border-gray-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div>
                      ...
                      <div className="flex gap-2">
                        <select className="px-2 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-400 w-[72px]">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2">
                        <select className="px-2 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none w-[72px]">
                          <option>🇮🇳 +91</option>
                        </select>
                ...
                <div className="relative p-4 md:p-5 bg-white rounded-xl border border-gray-200">
                  ...
                  {showCategoryInput && (
                    <div className="mb-4 p-3 bg-gray-50 rounded-lg flex flex-wrap gap-2">
                      <input type="text" value={newCategory} onChange={e => setNewCategory(e.target.value)} placeholder="Enter new category" className={`${inputCls} flex-1`} />
                ...
                {/* 06 Other Details - Updated with Bank Details and Subscription Type */}
                <div className="relative p-4 md:p-5 bg-white rounded-xl border border-gray-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select value={otherDetails.subscriptionType} onChange={e => handleOtherDetailsChange('subscriptionType', e.target.value)} className={inputCls}>
                        <option value="">Select Subscription Type</option>
                        <option value="basic">Basic - ₹999/month</option>
                        <option value="standard">Standard - ₹1,999/month</option>
                        <option value="premium">Premium - ₹3,999/month</option>
                  ...
                  <div className="mt-6 pt-4 border-t border-gray-200">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input type="text" value={otherDetails.bankName} onChange={e => handleOtherDetailsChange('bankName', e.target.value)} placeholder="Enter Bank Name" className={inputCls} />
                      </div>
                      <div>
                        <label className={labelCls}>Account Number</label>
                        <input type="text" value={otherDetails.accountNumber} onChange={e => handleOtherDetailsChange('accountNumber', e.target.value)} placeholder="Enter Account Number" className={inputCls} />
                      </div>
                      <div>
                        <label className={labelCls}>IFSC Code</label>
                        <input type="text" value={otherDetails.ifscCode} onChange={e => handleOtherDetailsChange('ifscCode', e.target.value)} placeholder="Enter IFSC Code" className={inputCls} />
                      </div>
                      <div>
                        <label className={labelCls}>UPI ID</label>
                        <input type="text" value={otherDetails.upiId} onChange={e => handleOtherDetailsChange('upiId', e.target.value)} placeholder="Enter UPI ID (e.g., name@bank)" className={inputCls} />
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div style={{ background: 'white', borderRadius: 12, border: '1px solid #e5e7eb', position: 'sticky', top: 20 }}>
              ...
              <div className="p-4">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  {otherDetails.subscriptionType && (
                    <div>
                      <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-1.5">Subscription</p>
                      <p className="text-xs text-gray-600 capitalize">{otherDetails.subscriptionType}</p>
                    </div>
                  )}
